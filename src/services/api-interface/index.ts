...
export * from './caching/local-http-cache';
export * from './caching/local-ongoing-http-cache';
...
export * from './getData-api-interface.service';
export * from './simple-api-interface.service';
