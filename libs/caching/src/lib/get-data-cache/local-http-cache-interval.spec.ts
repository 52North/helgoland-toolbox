...
describe('LocalHttpCacheInterval', () => {
    ...
    it('should get intersection correctly', inject([LocalHttpCacheInterval], (service: LocalHttpCacheInterval) => {
        ...
        expect(service.getIntersection(url2, new Timespan(100, 100), generalize)).toEqual(resultURL2);
        // should be: outside range
        expect(service.getIntersection(url1, new Timespan(0, 50), generalize)).toEqual(result1);
        // should be: intersection by 1 timeperiod before first cached item
        expect(service.getIntersection(url1, new Timespan(0, 100), generalize)).toEqual(result2);
        // should be: intersection by 1 timeperiod after first cached item
        expect(service.getIntersection(url1, new Timespan(1100, 1300), generalize)).toEqual(result3);
        // should be: no difference = complete intersection
        expect(service.getIntersection(url1, new Timespan(101, 299), generalize)).toEqual(result4);
        // should be: no difference = complete intersection
        expect(service.getIntersection(url1, new Timespan(100, 300), generalize)).toEqual(result5);
        // should be: no difference = complete intersection
        expect(service.getIntersection(url1, new Timespan(100, 301), generalize)).toEqual(result51);
        ...
        // should be: no difference = complete intersection
        expect(service.getIntersection(url1, new Timespan(550, 650), generalize)).toEqual(result6);
        // should be: intersection inbetween two timeperiods
        expect(service.getIntersection(url1, new Timespan(200, 600), generalize)).toEqual(result7);
        // should be: intersection inbetween four timeperiods
        expect(service.getIntersection(url1, new Timespan(200, 800), generalize)).toEqual(result8);
        // should be: intersection inbetween three timeperiods
        expect(service.getIntersection(url1, new Timespan(310, 710), generalize)).toEqual(result81);
        // should be: intersection in five timeperiods with outside range
        expect(service.getIntersection(url1, new Timespan(0, 1400), generalize)).toEqual(result9);
        // should be: intersection in four timeperiods, endings inside intersection
        expect(service.getIntersection(url1, new Timespan(300, 950), generalize)).toEqual(result10);
        // should be: complete intersection with element of 1 timeperiod
        expect(service.getIntersection(url1, new Timespan(1100, 1100), generalize)).toEqual(result11);
    }));
