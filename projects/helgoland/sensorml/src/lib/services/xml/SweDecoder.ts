...
export class SweDecoder {
  ...
  public decodeCoordinate(node: Element): ReturnObject<SweCoordinate> {
    ...
    if (coordinate.coordinate == null) {
      const quantityReturnObject: ReturnObject<SweQuantity> =
        this.decodeQuantity(node);
      if (quantityReturnObject) {
        coordinate.coordinate = quantityReturnObject.value;
        this._profileIDMap = this.utils.processProfileID(
          quantityReturnObject.docElement,
          coordinate,
          'coordinate',
          this._profileIDMap,
        );
  ...
  public decodeField(fieldNode: Element): ReturnObject<SweField> {
    ...
    const returnObject: ReturnObject<AbstractDataComponent> =
      this.decodeDataComponent(fieldNode.firstElementChild);
    if (returnObject) {
  ...
  public decodeDataStream(elem: Element): ReturnObject<SweDataStream> {
    ...
    if (dataStreamElem != null) {
      ...
      const returnObject: ReturnObject<SweElementType> =
        this.decodeElementType(dataStreamElem);
      if (returnObject) {
      ...
      const values = this.utils.getElement(
        dataStreamElem,
        'values',
        NAMESPACES.SWE,
      );
  ...
  public decodeTextEncoding(elem: Element): ReturnObject<SweTextEncoding> {
    ...
    if (textEncodingElem != null) {
      ...
      if (textEncodingElem.hasAttribute('collapseWhiteSpace')) {
        textEncoding.collapseWhiteSpace =
          textEncodingElem.getAttribute('collapseWhiteSpace') === 'true';
        this._profileIDMap = this.utils.processProfileID(
          textEncodingElem,
          textEncoding,
          'collapseWhiteSpace',
      ...
      if (textEncodingElem.hasAttribute('decimalSeparator')) {
        textEncoding.decimalSeparator =
          textEncodingElem.getAttribute('decimalSeparator');
        this._profileIDMap = this.utils.processProfileID(
          textEncodingElem,
          textEncoding,
          'decimalSeparator',
      ...
      if (textEncodingElem.hasAttribute('tokenSeparator')) {
        textEncoding.tokenSeparator =
          textEncodingElem.getAttribute('tokenSeparator');
        this._profileIDMap = this.utils.processProfileID(
          textEncodingElem,
          textEncoding,
          'tokenSeparator',
      ...
      if (textEncodingElem.hasAttribute('blockSeparator')) {
        textEncoding.blockSeparator =
          textEncodingElem.getAttribute('blockSeparator');
        this._profileIDMap = this.utils.processProfileID(
          textEncodingElem,
          textEncoding,
          'blockSeparator',
  ...
  public decodeBinaryEncoding(elem: Element): ReturnObject<SweBinaryEncoding> {
    ...
    if (binaryEncodingElem != null) {
      ...
      if (
        binaryEncodingElem.hasAttribute('byteLength') &&
        !isNaN(+binaryEncodingElem.getAttribute('byteLength'))
      ) {
        binaryEncoding.byteLength =
          +binaryEncodingElem.getAttribute('byteLength');
      }
  ...
  public decodeBinaryComponent(
    ...
    if (componentElem != null) {
      ...
      if (
        componentElem.hasAttribute('significantBits') &&
        !isNaN(+componentElem.getAttribute('significantBits'))
      ) {
        component.significantBits =
          +componentElem.getAttribute('significantBits');
        this._profileIDMap = this.utils.processProfileID(
          componentElem,
          component,
          'significantBits',
      ...
      if (
        componentElem.hasAttribute('bitLength') &&
        !isNaN(+componentElem.getAttribute('bitLength'))
      ) {
      ...
      if (
        componentElem.hasAttribute('byteLength') &&
        !isNaN(+componentElem.getAttribute('byteLength'))
      ) {
  ...
  public decodeBinaryBlock(elem: Element): ReturnObject<SweBinaryBlock> {
    ...
    if (blockElem != null) {
      ...
      if (
        blockElem.hasAttribute('paddingBytes-after') &&
        !isNaN(+blockElem.getAttribute('paddingBytes-after'))
      ) {
      ...
      if (
        blockElem.hasAttribute('paddingBytes-before') &&
        !isNaN(+blockElem.getAttribute('paddingBytes-before'))
      ) {
        block.paddingBytesBefore = +blockElem.getAttribute(
          'paddingBytes-before',
        );
        this._profileIDMap = this.utils.processProfileID(
          blockElem,
      ...
      if (
        blockElem.hasAttribute('byteLength') &&
        !isNaN(+blockElem.getAttribute('byteLength'))
      ) {
  ...
  public decodeDataChoiceItem(elem: Element): ReturnObject<SweDataChoiceItem> {
    ...
    if (elem.firstElementChild != null) {
      const returnObject: ReturnObject<AbstractDataComponent> =
        this.decodeDataComponent(elem.firstElementChild);
      if (returnObject) {
  ...
  public decodeQuantityRange(elem: Element): ReturnObject<SweQuantityRange> {
    ...
    if (quantityRangeElem != null) {
      ...
      const returnObject: ReturnObject<UnitOfMeasure> =
        this.decodeUnitOfMeasure(elem);
      if (returnObject) {
      ...
      const constraint = this.utils.getElement(
        quantityRangeElem,
        'constraint',
        NAMESPACES.SWE,
      );
      if (constraint != null) {
        const allowedValues: ReturnObject<AllowedValues> =
          this.decodeAllowedValues(constraint);
        if (allowedValues) {
          quantityRange.constraint = allowedValues.value;
          this._profileIDMap = this.utils.processProfileID(
            allowedValues.docElement,
            quantityRange,
            'constraint',
            this._profileIDMap,
          );
      ...
      const valueElem = this.utils.getElement(
        quantityRangeElem,
        'value',
        NAMESPACES.SWE,
      );
  ...
  public decodeTimeRange(elem: Element): ReturnObject<SweTimeRange> {
    ...
    if (timeRangeElem != null) {
      ...
      const returnObject: ReturnObject<UnitOfMeasure> =
        this.decodeUnitOfMeasure(timeRangeElem);
      if (returnObject) {
      ...
      if (constraint != null) {
        const allowedTimes: ReturnObject<AllowedTimes> =
          this.decodeAllowedTimes(constraint);
        if (allowedTimes) {
          timeRange.constraint = allowedTimes.value;
          this._profileIDMap = this.utils.processProfileID(
            allowedTimes.docElement,
            timeRange,
            'constraint',
            this._profileIDMap,
          );
  ...
  public decodeCountRange(elem: Element): ReturnObject<SweCountRange> {
    ...
    if (countRangeElem != null) {
      ...
      if (constraint != null) {
        const returnObject: ReturnObject<AllowedValues> =
          this.decodeAllowedValues(constraint);
        if (returnObject) {
  ...
  public decodeCategoryRange(elem: Element): ReturnObject<SweCategoryRange> {
    ...
    if (categoryRangeElem != null) {
      ...
      const returnObject: ReturnObject<string> =
        this.utils.getAttributeOfElement(
          categoryRangeElem,
          'codeSpace',
          NAMESPACES.SWE,
          'href',
      ...
      const constraintElem = this.utils.getElement(
        categoryRangeElem,
        'constraint',
        NAMESPACES.SWE,
      );
      if (constraintElem != null) {
        const allowedTokens: ReturnObject<AllowedTokens> =
          this.decodeAllowedTokens(constraintElem);
        if (allowedTokens) {
          categoryRange.constraint = allowedTokens.value;
          this._profileIDMap = this.utils.processProfileID(
            allowedTokens.docElement,
            categoryRange,
            'constraint',
            this._profileIDMap,
          );
  ...
  public decodeQuantity(elem: Element): ReturnObject<SweQuantity> {
    ...
    if (quantityElem != null) {
      ...
      if (constraint != null) {
        const allowedValuesObject: ReturnObject<AllowedValues> =
          this.decodeAllowedValues(constraint);
        if (allowedValuesObject) {
          quantity.constraint = allowedValuesObject.value;
          this._profileIDMap = this.utils.processProfileID(
            allowedValuesObject.docElement,
            quantity,
            'constraint',
            this._profileIDMap,
          );
      ...
      const value = this.utils.getElement(
        quantityElem,
        'value',
        NAMESPACES.SWE,
      );
      ...
      const returnObject: ReturnObject<UnitOfMeasure> =
        this.decodeUnitOfMeasure(quantityElem);
      if (returnObject) {
  ...
  public decodeTime(elem: Element): ReturnObject<SweTime> {
    ...
    if (timeElem != null) {
      ...
      const returnObject: ReturnObject<UnitOfMeasure> =
        this.decodeUnitOfMeasure(timeElem);
      if (returnObject) {
  ...
  public decodeCategory(elem: Element): ReturnObject<SweCategory> {
    ...
    if (catElem != null) {
      ...
      if (constraint != null) {
        const allowedTokens: ReturnObject<AllowedTokens> =
          this.decodeAllowedTokens(constraint);
        if (allowedTokens) {
  ...
  public decodeText(elem: Element): ReturnObject<SweText> {
    ...
    if (textElem != null) {
      ...
      if (constraint != null) {
        const returnObject: ReturnObject<AllowedTokens> =
          this.decodeAllowedTokens(constraint);
        if (returnObject) {
  ...
  public decodeAllowedTokens(elem: Element): ReturnObject<AllowedTokens> {
    ...
    if (allowedTokensElem != null) {
      ...
      this.utils.getDecodedList(
        ...
        (v) =>
          new ReturnObject(
            allowedTokens.values.push(v.textContent),
            allowedTokensElem,
          ),
      );

      const pattern = this.utils.getElement(
        allowedTokensElem,
        'pattern',
        NAMESPACES.SWE,
      );
  ...
  public decodeAllowedValues(elem: Element): ReturnObject<AllowedValues> {
    ...
    if (allowedValuesElem != null) {
      ...
      const significantFigures = this.utils.getElement(
        allowedValuesElem,
        'significantFigures',
        NAMESPACES.SWE,
      );
      if (
        ...
        !isNaN(+significantFigures.textContent)
      ) {
    ...
    if (allowedTimesElem != null) {
        ...
        (entry) => {
          if (!isNaN(Date.parse(entry.textContent))) {
            return new ReturnObject(
              new Date(Date.parse(entry.textContent)),
              entry,
            );
          }
          return new ReturnObject(null, null);
      ...
      allowedTimes.values = this.utils.getDecodedList(
        ...
        (entry) => {
          ...
          if (
            interval.length === 2 &&
            !isNaN(Date.parse(interval[0])) &&
            !isNaN(Date.parse(interval[1]))
          ) {
            return new ReturnObject(
              [
  ...
  public decodeAbstractSweIdentifiable(
    ...
    if (
      elem.getElementsByTagNameNS(NAMESPACES.SWE, 'identifier').length === 1
    ) {
      object.identifier = elem.getElementsByTagNameNS(
        NAMESPACES.SWE,
        'identifier',
      )[0].textContent;
    }
    ...
    if (elem.getElementsByTagNameNS(NAMESPACES.SWE, 'label').length === 1) {
      object.label = elem.getElementsByTagNameNS(
        NAMESPACES.SWE,
        'label',
      )[0].textContent;
    }
    ...
    if (
      elem.getElementsByTagNameNS(NAMESPACES.SWE, 'description').length === 1
    ) {
      object.description = elem.getElementsByTagNameNS(
        NAMESPACES.SWE,
        'description',
      )[0].textContent;
    }
  ...
  public decodeAbstractSimpleComponent(
    ...
    const outerNilValuesElem = this.utils.getElement(
      elem,
      'nilValues',
      NAMESPACES.SWE,
    );
    if (outerNilValuesElem != null) {
      const innerNilValuesElem = this.utils.getElement(
        outerNilValuesElem,
        'NilValues',
        NAMESPACES.SWE,
      );
  ...
  private decodeAbstractDataArray(
    elem: Element,
    component: SweDataArray,
  ): void {
    this.decodeAbstractDataComponent(elem, component);

    const elementCount = this.utils.getElement(
      elem,
      'elementCount',
      NAMESPACES.SWE,
    );
    ...
    const elementType = this.utils.getElement(
      elem,
      'elementType',
      NAMESPACES.SWE,
    );
    if (elementType != null) {
      const returnObject: ReturnObject<SweElementType> =
        this.decodeElementType(elementType);
      if (returnObject) {
    ...
    if (encoding != null) {
      const returnObject: ReturnObject<SweEncoding> =
        this.decodeAbstractEncoding(encoding);
      if (returnObject) {
