...
export class SweEncoder {
  ...
  public encodeField(field: SweField, document: Document): Node {
    ...
    if (field.component) {
      fieldNode.appendChild(
        this.encodeDataComponent(field.component, document),
      );
    }
    return fieldNode;
  }
  ...
  public encodeDataRecord(component: SweDataRecord, document: Document): Node {
    ...
    if (component.fields) {
      component.fields.forEach((field) =>
        node.appendChild(this.encodeField(field, document)),
      );
    }
  ...
  public encodeTextEncoding(
    ...
    if (encoding.collapseWhiteSpace != null) {
      node.setAttribute(
        'collapseWhiteSpace',
        encoding.collapseWhiteSpace.toString(),
      );
    }
  ...
  public encodeBinaryEncoding(
    ...
    if (encoding.members) {
      encoding.members.forEach((member) => {
        const memberNode = document.createElementNS(
          NAMESPACES.SWE,
          'swe:member',
        );
  ...
  public encodeBinaryBlock(block: SweBinaryBlock, document: Document): Node {
    ...
    if (block.paddingBytesAfter != null) {
      node.setAttribute(
        'paddingBytes-after',
        block.paddingBytesAfter.toString(),
      );
    }
    ...
    if (block.paddingBytesBefore != null) {
      node.setAttribute(
        'paddingBytes-before',
        block.paddingBytesBefore.toString(),
      );
    }
  ...
  public encodeDataChoice(component: SweDataChoice, document: Document): Node {
    ...
    if (component.choiceValue && component.choiceValue.length > 0) {
      const choiceValueNode = document.createElementNS(
        NAMESPACES.SWE,
        'swe:choiceValue',
      );
  ...
  public encodeQuantityRange(
    ...
    if (component.constraint && component.constraint.values.length > 0) {
      ...
      constraintNode.appendChild(
        this.encodeAllowedValues(component.constraint, document),
      );
  ...
  public encodeTimeRange(component: SweTimeRange, document: Document): Node {
    ...
    if (component.constraint && component.constraint.values.length > 0) {
      ...
      constraintNode.appendChild(
        this.encodeAllowedTimes(component.constraint, document),
      );
      node.appendChild(constraintNode);
    }
  ...
  public encodeCategoryRange(
    ...
    if (component.constraint && component.constraint.values.length > 0) {
      ...
      constraintNode.appendChild(
        this.encodeAllowedTokens(component.constraint, document),
      );
      node.appendChild(constraintNode);
    }
  ...
  public encodeAllowedTokens(
    ...
    if (allowedTokens.pattern) {
      const patternNode = document.createElementNS(
        NAMESPACES.SWE,
        'swe:pattern',
      );
    ...
    if (allowedTimes.values) {
      ...
      allowedTimes.values.forEach((allowedTime) => {
        if (allowedTime instanceof Array) {
          ...
          const intervalNode = document.createElementNS(
            NAMESPACES.SWE,
            'swe:interval',
          );
  ...
  public encodeAbstractSimpleComponent(
    ...
    if (component.quality) {
      component.quality.forEach((quality) =>
        node.appendChild(this.encodeQuality(quality, document)),
      );
    }

    if (component.nilValues && component.nilValues.length > 0) {
      const outerNilValuesNode = document.createElementNS(
        NAMESPACES.SWE,
        'swe:nilValues',
      );
      const innerNilValuesNode = document.createElementNS(
        NAMESPACES.SWE,
        'swe:NilValues',
      );
      outerNilValuesNode.appendChild(innerNilValuesNode);
      node.appendChild(outerNilValuesNode);
      component.nilValues.forEach((nilValue) =>
        innerNilValuesNode.appendChild(this.encodeNilValue(nilValue, document)),
      );
    }
  ...
  public encodeDataStream(dataStream: SweDataStream, document: Document): Node {
    ...
    if (dataStream.elementCount && dataStream.elementCount.length > 0) {
      const elementCountNode = document.createElementNS(
        NAMESPACES.SWE,
        'swe:elementCount',
      );
    ...
    if (dataStream.elementType) {
      node.appendChild(
        this.encodeElementType(dataStream.elementType, document),
      );
    }
    ...
    if (dataStream.encoding) {
      ...
      encodingNode.appendChild(
        this.encodeAbstractEncoding(dataStream.encoding, document),
      );
  ...
  private encodeAbstractDataArray(
    node: Element,
    ...
    if (component.elementCount != null) {
      const countNode = document.createElementNS(
        NAMESPACES.SWE,
        'swe:elementCount',
      );
    ...
    if (component.encoding) {
      ...
      encodingNode.appendChild(
        this.encodeAbstractEncoding(component.encoding, document),
      );
      node.appendChild(encodingNode);
    }
