...
import { OlLayerOpacitiySliderComponent } from './controls/legend/ol-layer-opacitiy-slider/ol-layer-opacitiy-slider.component';
...
import { OlLayerVisibilityTogglerComponent } from './controls/legend/ol-layer-visibility-toggler/ol-layer-visibility-toggler.component';
...
@NgModule({
  exports: COMPONENTS,
  imports: [CommonModule, FormsModule, HelgolandCoreModule, ...COMPONENTS],
})
