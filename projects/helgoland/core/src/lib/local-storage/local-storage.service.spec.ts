...
describe('LocalStorage', () => {
  ...
  it('should save and load data', inject(
    [LocalStorage],
  ...
  it('should save and load data array', inject(
    [LocalStorage],
    (service: LocalStorage) => {
  ...
  it('should be null on wrong parameter name', inject(
    [LocalStorage],
    (service: LocalStorage) => {
  ...
  it('should load textual content', inject(
    [LocalStorage],
    (service: LocalStorage) => {
