...
describe("Time", () => {
  ...
  it("should overlaps", inject([Time], (service: Time) => {
    ...
    expect(service.createTimespanOfInterval(buffered)).toEqual(new Timespan(450000, 550000));
  }));

  it("should overlaps", inject([Time], (service: Time) => {
    const timespan = new Timespan(500000, 600000);
    expect(service.getBufferedTimespan(timespan, 0.1)).toEqual(new Timespan(490000, 610000));
  }));
