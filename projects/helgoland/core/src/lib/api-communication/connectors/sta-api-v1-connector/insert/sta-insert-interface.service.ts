...
export class StaInsertInterfaceService implements StaInsertInterface {
  ...
  insertDatastream(
    ...
    return this.http.post<Datastream>(
  ...
  insertFeatureOfInterest(
    ...
    return this.http.post<FeatureOfInterest>(
  ...
  insertHistoricalLocation(
    ...
    return this.http.post<HistoricalLocation>(
  ...
  insertObservedProperty(
    ...
    return this.http.post<ObservedProperty>(
  ...
  insertSensor(apiUrl: string, sensor: InsertSensor): Observable<Sensor> {
    return this.http.post<Sensor>(
      this.createRequestUrl(apiUrl, StaEndpoint.Sensors),
      sensor,
    );
  }

  insertThing(apiUrl: string, thing: InsertThing): Observable<Thing> {
    return this.http.post<Thing>(
      this.createRequestUrl(apiUrl, StaEndpoint.Things),
      thing,
    );
  }
