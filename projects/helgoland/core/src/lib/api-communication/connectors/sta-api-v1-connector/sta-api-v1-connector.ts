...
export class StaApiV1Connector implements HelgolandServiceConnector {
  ...
  getCategory(
    ...
    if (this.filterTimeseriesMatchesNot(filter)) {
      return throwError('Could not create category');
    }
    return this.sta
  ...
  getOffering(
    ...
    if (this.filterTimeseriesMatchesNot(filter)) {
      return throwError('Could not create offering');
    }
  ...
  getPhenomena(
    ...
    return this.sta
      .aggregatePaging(
        this.sta.getObservedProperties(url, this.createPhenomenaFilter(filter)),
      )
      .pipe(
  ...
  getPhenomenon(
    ...
    if (this.filterTimeseriesMatchesNot(filter)) {
      return throwError('Could not create phenomenon');
    }
    return this.sta
      .getObservedProperty(url, id)
  ...
  getProcedure(
    ...
    if (this.filterTimeseriesMatchesNot(filter)) {
      return throwError('Could not create procedure');
    }
    return this.sta
      .getSensor(url, id)
  ...
  getFeatures(
    ...
    return this.sta
      .aggregatePaging(
        this.sta.getLocations(url, this.createFeaturesFilter(filter)),
      )
  ...
  getFeature(
    ...
    if (this.filterTimeseriesMatchesNot(filter)) {
      return throwError('Could not create feature');
    }
    return this.sta
      .getLocation(url, id)
  ...
  getPlatform(
    ...
    if (this.filterTimeseriesMatchesNot(filter)) {
      return throwError('Could not create platform');
    }
    return this.sta
      .getLocation(url, id, {
        $expand:
  ...
  getDataset(
    ...
    if (this.filterTimeseriesMatchesNot(filter)) {
      return throwError('Could not create dataset');
    }
