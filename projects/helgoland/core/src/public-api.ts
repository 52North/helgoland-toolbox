...
export {
  DatasetApiInterface,
  UriParameterCoder,
} from './lib/dataset-api/api-interface';
export {
  DatasetApiMapping,
  DatasetApiVersion,
} from './lib/dataset-api/api-mapping.service';
...
export {
  InternalDatasetId,
  InternalIdHandler,
} from './lib/dataset-api/internal-id-handler.service';
export {
...
export * from './lib/api-communication/connectors/sta-api-v1-connector/sta-interface.service';
