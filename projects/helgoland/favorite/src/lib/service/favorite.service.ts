...
export class FavoriteService {
  ...
  private loadFavorites(): void {
    ...
    const loadedSingleFavs = this.localStorage.loadArray<SingleFavorite>(
    ...
    const loadedGroupFavs = this.localStorage.loadArray<GroupFavorite>(
      CACHE_PARAM_FAVORITES_GROUP,
    );
    if (loadedGroupFavs) {
