...
describe('D3TimeseriesGraphComponent - function', () => {
  ...
  beforeEach(inject(
    [BasicAuthServiceMaintainer],
    (basicAuthServiceMaintainer: BasicAuthServiceMaintainer) => {
  ...
  it('should have a dataset', () => {
    ...
    component.timeInterval = definedTimespanSrvc.getInterval(
    ...
    component.onContentLoading.subscribe((loading) =>
