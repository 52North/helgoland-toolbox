...
export class D3YAxisModifierComponent
  extends D3TimeseriesGraphControl
  ...
  protected drawZoomButtons(yaxis: YAxis, buttonSize: number, xAlign: number) {
    if (
      ...
      this.d3Graph
        ...
        .attr(
          'class',
          'axis-button-line zoom-button zoom-in y-axis-modifier-button',
        )
      ...
      const zoomInHover = this.d3Graph
        .getGraphElem()
        .append('circle')
        .attr(
          'class',
          'axis-button-circle zoom-button zoom-in zoom-circle y-axis-modifier-button',
        )
        .attr('cx', xAlign)
      ...
      this.d3Graph
        ...
        .attr(
          'class',
          'axis-button-line zoom-button zoom-out y-axis-modifier-button',
        )
        .attr('x1', xAlign - buttonSize)
      ...
      const zoomOutHover = this.d3Graph
        .getGraphElem()
        .append('circle')
        .attr(
          'class',
          'axis-button-circle zoom-button zoom-out zoom-circle y-axis-modifier-button',
        )
        .attr('cx', xAlign)
  ...
  protected drawResetButton(yaxis: YAxis, buttonSize: number, xAlign: number) {
    if (this.d3Graph && this.adjustedRanges.has(this.generateKey(yaxis))) {
      ...
      this.d3Graph
        ...
        .attr(
          'class',
          'axis-button-line reset-button reset-line y-axis-modifier-button',
        )
      ...
      const resetHover = this.d3Graph
        .getGraphElem()
        .append('circle')
        .attr(
          'class',
          'axis-button-circle reset-button reset-circle y-axis-modifier-button',
        )
        .attr('cx', xAlign)
  ...
  protected drawShiftButtons(yaxis: YAxis, buttonSize: number, xAlign: number) {
    if (
      ...
      this.d3Graph
        ...
        .attr(
          'class',
          'axis-button-line shift-button shift-up y-axis-modifier-button',
        )
      ...
      const shiftUpHover = this.d3Graph
        .getGraphElem()
        .append('circle')
        .attr(
          'class',
          'axis-button-circle shift-button shift-up shift-circle y-axis-modifier-button',
        )
        .attr('cx', xAlign)
      ...
      this.d3Graph
        ...
        .attr(
          'class',
          'axis-button-line shift-button shift-down y-axis-modifier-button',
        )
        .attr('x1', xAlign - buttonSize + 1)
      ...
      const shiftDownHover = this.d3Graph
        .getGraphElem()
        .append('circle')
        .attr(
          'class',
          'axis-button-circle shift-button shift-down shift-circle y-axis-modifier-button',
        )
        .attr('cx', xAlign)
