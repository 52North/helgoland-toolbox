...
| :--------------------- | :---------------------------------------------------------------------------- | :---------------- | :------------------------------------- |
| MIT                    | git+https://github.com/angular/angular.git                                    | 17.3.5            | @angular/animations                    |
| MIT                    | git+https://github.com/angular/components.git                                 | 17.3.5            | @angular/cdk                           |
| MIT                    | git+https://github.com/angular/angular.git                                    | 17.3.5            | @angular/common                        |
| MIT                    | git+https://github.com/angular/angular.git                                    | 17.3.5            | @angular/compiler                      |
| MIT                    | git+https://github.com/angular/angular.git                                    | 17.3.5            | @angular/core                          |
| MIT                    | git+https://github.com/angular/angular.git                                    | 17.3.5            | @angular/forms                         |
| MIT                    | git+https://github.com/angular/components.git                                 | 17.3.5            | @angular/material                      |
| MIT                    | git+https://github.com/angular/components.git                                 | 17.3.5            | @angular/material-moment-adapter       |
| MIT                    | git+https://github.com/angular/angular.git                                    | 17.3.5            | @angular/platform-browser              |
| MIT                    | git+https://github.com/angular/angular.git                                    | 17.3.5            | @angular/platform-browser-dynamic      |
| MIT                    | git+https://github.com/angular/angular.git                                    | 17.3.5            | @angular/router                        |
...
| 0BSD                   | git+https://github.com/Microsoft/tslib.git                                    | 2.6.2             | tslib                                  |
| Apache-2.0             | git+https://github.com/mreuvers/typescript-logging.git                        | 0.6.4             | typescript-logging                     |
| Apache-2.0             | n/a                                                                           | 0.20.3            | xlsx                                   |
| MIT                    | git://github.com/angular/angular.git                                          | 0.14.2            | zone.js                                |
| MIT                    | git+https://github.com/angular/angular-cli.git                                | 17.3.5            | @angular-devkit/build-angular          |
| MIT                    | git+https://github.com/angular-eslint/angular-eslint.git                      | 17.3.0            | @angular-eslint/builder                |
| MIT                    | git+https://github.com/angular-eslint/angular-eslint.git                      | 17.3.0            | @angular-eslint/eslint-plugin          |
| MIT                    | git+https://github.com/angular-eslint/angular-eslint.git                      | 17.3.0            | @angular-eslint/eslint-plugin-template |
| MIT                    | git+https://github.com/angular-eslint/angular-eslint.git                      | 17.3.0            | @angular-eslint/schematics             |
| MIT                    | git+https://github.com/angular-eslint/angular-eslint.git                      | 17.3.0            | @angular-eslint/template-parser        |
| MIT                    | git+https://github.com/angular/angular-cli.git                                | 17.3.5            | @angular/cli                           |
| MIT                    | git+https://github.com/angular/angular.git                                    | 17.3.5            | @angular/compiler-cli                  |
...
| MIT                    | git+https://github.com/typescript-eslint/typescript-eslint.git                | 7.7.1             | @typescript-eslint/eslint-plugin       |
| BSD-2-Clause           | git+https://github.com/typescript-eslint/typescript-eslint.git                | 7.7.1             | @typescript-eslint/parser              |
| MIT                    | git+ssh://git@github.com/vendure-ecommerce/ngx-translate-extract.git          | 9.1.1             | @vendure/ngx-translate-extract         |
| MIT                    | git+https://github.com/archiverjs/node-archiver.git                           | 5.3.1             | archiver                               |
| MIT                    | git+https://github.com/eslint/eslint.git                                      | 8.57.0            | eslint                                 |
...
| MIT                    | git+https://github.com/ng-packagr/ng-packagr.git                              | 17.0.2            | ng-packagr                             |
| MIT                    | git+https://github.com/prettier/prettier.git                                  | 3.1.1             | prettier                               |
| MIT                    | git+https://github.com/prettier/prettier-eslint.git                           | 16.2.0            | prettier-eslint                        |
...
| Apache-2.0             | git+https://github.com/microsoft/TypeScript.git                               | 5.2.2             | typescript                             |
