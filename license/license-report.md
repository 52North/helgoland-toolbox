...
| :--------------------- | :---------------------------------------------------------------------------- | :---------------- | :------------------------------------- |
| MIT                    | git+https://github.com/angular/angular.git                                    | 20.0.6            | @angular/animations                    |
| MIT                    | git+https://github.com/angular/components.git                                 | 20.0.5            | @angular/cdk                           |
| MIT                    | git+https://github.com/angular/angular.git                                    | 20.0.6            | @angular/common                        |
| MIT                    | git+https://github.com/angular/angular.git                                    | 20.0.6            | @angular/compiler                      |
| MIT                    | git+https://github.com/angular/angular.git                                    | 20.0.6            | @angular/core                          |
| MIT                    | git+https://github.com/angular/angular.git                                    | 20.0.6            | @angular/forms                         |
| MIT                    | git+https://github.com/angular/components.git                                 | 20.0.5            | @angular/material                      |
| MIT                    | git+https://github.com/angular/components.git                                 | 20.0.5            | @angular/material-moment-adapter       |
...
| MIT                    | git://github.com/angular/angular.git                                          | 0.15.1            | zone.js                                |
| MIT                    | git+https://github.com/angular-eslint/angular-eslint.git                      | 20.1.1            | @angular-eslint/builder                |
| MIT                    | git+https://github.com/angular-eslint/angular-eslint.git                      | 20.1.1            | @angular-eslint/eslint-plugin          |
| MIT                    | git+https://github.com/angular-eslint/angular-eslint.git                      | 20.1.1            | @angular-eslint/eslint-plugin-template |
| MIT                    | git+https://github.com/angular-eslint/angular-eslint.git                      | 20.1.1            | @angular-eslint/schematics             |
| MIT                    | git+https://github.com/angular-eslint/angular-eslint.git                      | 20.1.1            | @angular-eslint/template-parser        |
...
| MIT                    | git+https://github.com/typescript-eslint/typescript-eslint.git                | 8.35.1            | @typescript-eslint/parser              |
...
| Apache-2.0             | git+https://github.com/microsoft/TypeScript.git                               | 5.8.3             | typescript                             |
